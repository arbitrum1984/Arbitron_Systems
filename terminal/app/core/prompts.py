...
**3. Sentiment:**
- Score: [Numeric value -1.0 to 1.0 based on news sentiment] ([Label: Strong Bearish, Bearish, Neutral, Bullish, Strong Bullish])
...
**4. Visuals:**
- [Summarize the 'Visual Patterns' provided in the context data. If none, state "No clear patterns detected".]
